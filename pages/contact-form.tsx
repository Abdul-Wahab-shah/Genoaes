            ...
            <div className="flex flex-col gap-4">
                ...
                {fields.slice(0, 3).map(({ id, label, type, required }) => (
                  <div key={id} className="flex flex-col w-full md:w-1/3">
                    ...
                    <input
                      ...
                      className="p-2 border border-[#a7a6a6] text-white bg-transparent outline-none rounded-md"
                      required={required}
                    />
                  </div>
                ))}
              ...
              <div className="flex flex-col">
                ...
                <textarea
                  ...
                  className="p-2 border border-[#a7a6a6] text-white bg-transparent outline-none rounded-md h-32"
                ></textarea>
              </div>
              ...
              <div className="flex justify-end gap-4">
                ...
                <button
                  type="submit"
                  className="text-white border bg-transparent px-4 py-2 rounded border-[#a7a6a6]"
                >
                  Submit
                </button>
              </div>
